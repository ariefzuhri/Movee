...
public class FilterFavorite implements Parcelable {
    ...
    private boolean sortedByReleaseYear;
    ...
    protected FilterFavorite(Parcel in) {
        ...
        sortedByReleaseYear = in.readByte() != 0;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) (sortedByReleaseYear ? 1 : 0));
    ...
    public boolean isSortedByReleaseYear() {
        return sortedByReleaseYear;
    }

    public void setSortedByReleaseYear(boolean sortedByReleaseYear) {
        this.sortedByReleaseYear = sortedByReleaseYear;
    }
