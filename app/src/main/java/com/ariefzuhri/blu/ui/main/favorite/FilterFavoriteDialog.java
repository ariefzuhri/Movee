...
import com.ariefzuhri.blu.databinding.DialogFilterFavoriteBinding;
...
public class FilterFavoriteDialog extends DialogFragment implements View.OnClickListener {
    ...
    private void setCheckedChip(FilterFavorite filter) {
        ...
        binding.chipReleaseYear.setChecked(filter.isSortedByReleaseYear());
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_apply){
            ...
            filter.setSortedByReleaseYear(binding.chipReleaseYear.isChecked());
